// Function to fetch and display vegetarian dishes
function fetchAndDisplayVegetarianDishes() {
...
// Call the function to fetch and display vegetarian dishes when the page loads
fetchAndDisplayVegetarianDishes();
