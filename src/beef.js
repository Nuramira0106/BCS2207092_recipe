// Function to fetch and display beef dishes
function fetchAndDisplayBeefDishes() {
    fetch('https://www.themealdb.com/api/json/v1/1/filter.php?c=Beef')
        ...
        .catch(error => {
            console.error('Error fetching beef dishes:', error); // Log any errors
        });
}

// Function to fetch and show meal details by ID
...
// Call the function to fetch and display beef dishes when the page loads
fetchAndDisplayBeefDishes();
