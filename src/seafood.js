// Function to fetch and display seafood dishes
function fetchAndDisplaySeafoodDishes() {
    fetch('https://www.themealdb.com/api/json/v1/1/filter.php?c=Seafood')
        ...
        .catch(error => {
            console.error('Error fetching seafood dishes:', error);
        });
}
...
// Call the function to fetch and display seafood dishes when the page loads
fetchAndDisplaySeafoodDishes();
