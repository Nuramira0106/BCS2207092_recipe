// Function to fetch and display pasta dishes
function fetchAndDisplayPastaDishes() {
...
// Call the function to fetch and display pasta dishes when the page loads
fetchAndDisplayPastaDishes();
