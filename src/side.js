// Function to fetch and display side dishes
function fetchAndDisplaySideDishes() {
...
// Call the function to fetch and display side dishes when the page loads
fetchAndDisplaySideDishes();
