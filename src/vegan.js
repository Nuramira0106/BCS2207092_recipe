// Function to fetch and display vegan dishes
function fetchAndDisplayVeganDishes() {
    fetch('https://www.themealdb.com/api/json/v1/1/filter.php?c=Vegan')
        ...
        .catch(error => {
            console.error('Error fetching vegan dishes:', error);
        });
}
...
// Call the function to fetch and display vegan dishes when the page loads
fetchAndDisplayVeganDishes();
